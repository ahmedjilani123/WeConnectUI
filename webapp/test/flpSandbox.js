		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "My Track",
									"targetURL": "#ajsapmyexpenseapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ajsapmyexpenseapp-display": {
								"semanticObject": "ajsapmyexpenseapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=aj.sap.myexpenseapp",
									"url": sap.ui.require.toUrl("aj/sap/myexpenseapp")
								}
							}
						}
					}
